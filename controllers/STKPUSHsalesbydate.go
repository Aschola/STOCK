...
type DateRequestt struct {
	Date string `json:"date"`
}

// GetSalesByDate fetches sales based on the provided date from the sales_by_STKPUSH table.
func GetSTKPUSHSalesByDate(c echo.Context) error {
	...
	// Query sales by date (only matching the date part) from the sales_by_STKPUSH table
	var sales []models.SalebyCash // Ensure this struct is updated to match your STKPUSH sales model
